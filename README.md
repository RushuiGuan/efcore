...
| [Albatross.EFCore.Testing](./Albatross.EFCore.Testing)| A unit testing library that contains classes to create mock `DbSet<T>` and `IQueryable<T>` | [![NuGet Version](https://img.shields.io/nuget/v/Albatross.EFCore.Testing)](https://www.nuget.org/packages/Albatross.EFCore.Testing)                     |
